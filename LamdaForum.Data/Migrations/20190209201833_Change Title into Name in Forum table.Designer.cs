...
namespace LamdaForum.Core.Migrations
{
    ...
    [Migration("20190209201833_Change Title into Name in Forum table")]
    partial class ChangeTitleintoNameinForumtable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LamdaForum.Core.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LamdaForum.Core.Models.ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
